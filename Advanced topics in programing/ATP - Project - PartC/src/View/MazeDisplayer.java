...
public class MazeDisplayer extends Canvas {
    ...
    public void redraw() {
        if (maze != null) {
            ...
            try {
                Image wallImage = new Image(new FileInputStream("resources/Images/character1.jpg"));
                Image characterImage = new Image(new FileInputStream("resources/Images/wall3.jpg"));
